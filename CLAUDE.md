...
- [ ] **Fase 1 — Producción** · insumos, compras, recetas, costeo, órdenes, stock
...
- Correr `node test/fase-0.test.mjs` antes de cerrar cualquier fase. Si tocaste
  `db.js`, `auth.js` o `calc.js`, agregá el caso que cubra el cambio.
